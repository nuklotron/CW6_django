...
from emailer.views import ClientCreateView, main_page, ClientListView, ClientDetailView, ClientUpdateView, \
    ...
    MessageDeleteView, BlogListView, BlogDetailView, BlogCreateView, BlogUpdateView, BlogDeleteView, \
    toggle_activity
...
urlpatterns = [
    ...
    path('subscription_list/', MailingSettingsListView.as_view(), name='subscription_list'),
